...
Step 2: Simulate 10 clusters of a total of 200 3-gons, each cluster having 
10 3-gons each with 0.02 jitter (amount of jitter is modifiable).
```{r}
x <- 200
z <- 10
n <- 20
...
Step 5: Test the BACON clustering algorithm.
```{r}
...
pheatmap(mat = weight_performance,
         ...
         main = "Mean BACON performance over 10 replicates (n = 200; k = 3; z = 10)",
         xlab = "Angle Weight", 
